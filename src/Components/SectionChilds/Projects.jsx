...
export const Projects = ({HandleLang, texto}) => {
  ...
  return (
    ...
    <section className=" bg-box-sections-bgcolor shadow-tech-desk  h-[109rem] md:h-[65rem] rounded-[2.4rem] mx-5  mt-[1rem] mb-[13rem] md:mx-auto max-w-maximoAnchosmallwide">
                        ...
                        <article className="mx-auto md:grid md:grid-cols-3 py-[1rem]  border-projects">
                            ...
                            <section>
                                ...
                                <div className=" m-4 flex justify-evenly gap-1 ">
                                    ...
                                    <a target="_blank"
                                        href="https://github.com/Lautaro-Di-Salvo-Code/practica-sunnyside/tree/master/code"
                            ...
                            <section className="">
                                ...
                                <div className=" m-4 flex justify-evenly gap-1">
                                    ...
                                    <a target="_blank" href="https://github.com/Lautaro-Di-Salvo-Code/portfolio-2024"
                                        className=" py-[.5rem] rounded-xl px-[1rem] bg-color-botonesproyectos md:hover:bg-hovercolor-botonesproyectos md:cursor-pointer md:hover:scale-110 md:cursor-pointer transition duration-75 ease-linear  box-shadow-tech-desk">{texto.proyectos.codigo}</a>
                                </div>
                            </section>
                        </article>
                        {/* <!-- pizzeria --> */}
